...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/exhxx-tg/3x-ui-multiport/main/update.sh"
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/exhxx-tg/3x-ui-multiport/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()
