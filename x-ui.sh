...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/exhxx-tg/3x-ui-multiport/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/exhxx-tg/3x-ui-multiport/main/x-ui.sh
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/exhxx-tg/3x-ui-multiport/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
